 ...
 */
int tc_fred_eval_P(unsigned qmin, unsigned qmax, double prob)
{
	int i = qmax - qmin;
...
int tc_fred_eval_ewma(unsigned qmin, unsigned burst, unsigned avpkt)
{
	int wlog = 1;
	double W = 0.5;
...
int tc_fred_eval_idle_damping(int Wlog, unsigned avpkt, unsigned bps, __u8 *sbuf)
{
